# credit by CSC384 course assignment2 starter code on 2015Fall term, instructor: Fahiem Bacchus
...
class BT:
    ...
    def bt_search(self,propagator):
        ...
        if status == False and self.TRACE:
        ...
        result = {}
        for v in self.csp.vars:
            result[v.name] = v.get_assigned_value()
        return result
